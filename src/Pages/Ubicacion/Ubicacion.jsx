      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className="lg:col-span-2 ubic-animate opacity-0">
            <div className="double-bezel rounded-[2rem] p-2 h-[300px] sm:h-[350px] md:h-[400px]">
          ...
          <div className="ubic-animate opacity-0">
            <div className="double-bezel rounded-[2rem] p-2 h-full">
              <div className="double-bezel-inner rounded-[calc(2rem-0.25rem)] p-6 md:p-8 h-full flex flex-col">
