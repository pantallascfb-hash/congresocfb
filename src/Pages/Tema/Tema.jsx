  ...
  return (
    <div ref={sectionRef} className="section-padding">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <h2 className="tema-animate opacity-0 text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black text-navy leading-[0.92] tracking-[-0.02em] mb-10">
          NO TEMAS,
          <br />
        ...
        <div className="tema-animate opacity-0 max-w-2xl mx-auto mb-12">
          <blockquote className="relative">
            <div className="absolute -top-6 left-1/2 -translate-x-1/2 text-7xl text-gold/15" style={{ fontFamily: "'Playfair Display', serif" }}>
              &ldquo;
            </div>
            <p className="text-xl md:text-2xl text-navy italic leading-relaxed pt-8" style={{ fontFamily: "'Playfair Display', serif" }}>
              No temas, rebaño pequeño, porque vuestro Padre ha decidido daros el reino.
            </p>
            <footer className="mt-5 text-gold-dark text-sm font-semibold tracking-[0.15em]">
              — Lucas 12:32 (LBLA)
            </footer>
          </blockquote>
        </div>
